 ...
 *
 * CS338
 * Min-heap implementation from Data Structures and Algorithm Analysis
 *
 * author: Clifford A. Shaffer, Hongtao Wang, Micheal Murphy
 */
  ...
  private void siftdown(int pos) {
    ...
    while (!isLeaf(pos)) {
      ...
      if ((j<(n-1)) && (heap.get(j).compareTo(heap.get(j+1)) > 0))
        j++; // j is now index of child with less value
